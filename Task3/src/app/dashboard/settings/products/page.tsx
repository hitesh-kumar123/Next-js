    ...
    <main className="flex-1 p-10 relative overflow-hidden">
      ...
      <header className="mb-10">
        <h1 className="font-display text-3xl font-bold text-[#835500]">
          Product & Membership Catalog
        </h1>
        <p className="text-[#524534] text-sm mt-1">
          {userRole === 'Admin'
            ? 'Define memberships, passes, and class packages for checkout.'
            : 'Review currently configured memberships and packages.'}
        </p>
      </header>

      <ProductsClient initialProducts={products} isAdmin={userRole === 'Admin'} />
    </main>
  )
}
